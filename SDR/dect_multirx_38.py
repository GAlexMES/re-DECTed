...
class dect_multirx_38(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Dect Multirx 38")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Dect Multirx 38")
        ...
        self.settings = Qt.QSettings("GNU Radio", "dect_multirx_38")
...
def main(top_block_cls=dect_multirx_38, options=None):

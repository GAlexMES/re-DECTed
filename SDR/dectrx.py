...
class dectrx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._range_channel_range = Range(0, 9, 1, 5, 200)
        self._range_channel_win = RangeWidget(self._range_channel_range, self.set_range_channel, 'Channel', "counter_slider", float)
        self.top_grid_layout.addWidget(self._range_channel_win)
